...
#! /usr/bin/env python
"""
The following code is taken from Ego4D NLQ official implementation.
https://github.com/EGO4D/episodic-memory/blob/main/NLQ/VSLNet/utils/prepare_ego4d_dataset.py
